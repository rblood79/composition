...
- Apply Composition-specific behavior through `packages/specs`, runtime adapters,
  generated CSS, or Builder registration metadata.
...
4. Update the Composition starter manifest and affected ComponentSpecs.
5. Verify Panel, Factory, Preview, generated CSS, and Skia consumers together.

## Snapshot Metadata

- Imported into Composition path: `packages/react-aria-starter`
- Package role: upstream reference and future runtime adapter source
- Runtime customization owner: `packages/specs` and Composition adapters
