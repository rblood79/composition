...
export type ExtensionReadPriority = "legacy-first" | "props-first" | "legacy-only";
/**
 ...
 */
export declare function getElementEvents(element: LegacyElementWithExtension, priority?: ExtensionReadPriority): unknown[];
/**
 ...
 * 기존 cast 를 제거 가능.
 */
export declare function getElementDataBinding(element: LegacyElementWithExtension, priority?: ExtensionReadPriority): DataBinding | undefined;
export {};
//# sourceMappingURL=compositionExtensionFields.d.ts.map