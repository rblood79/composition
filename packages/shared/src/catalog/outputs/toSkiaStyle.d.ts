...
/** Skia 테마 (resolveToken color 채널 분기). */
export type SkiaTheme = "light" | "dark";
/**
 ...
 */
export declare function toSkiaStyle(node: CanonicalNode | ResolvedNode, theme?: SkiaTheme): Record<string, unknown>;
//# sourceMappingURL=toSkiaStyle.d.ts.map