 ...
 */
export const toastBinding = {
    source: {
        kind: "internal",
        // dedicated renderToast(LayoutRenderers.tsx) → <div role="alert"> + 자식. 키 값은 generic
        // fallback 용(Pagination "div" 동형, dedicated renderer 가 우선). D1 alert semantic 은 renderer 부여.
        renderer: "div",
    },
    props: {
        accepts: {
...
//# sourceMappingURL=Toast.binding.js.map