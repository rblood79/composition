...
export const avatarBinding = {
    ...
    props: {
        ...
        // React prop 으로 통과(StatusLight 선례 동형). data-size 도 함께 emit 되어 CSS/debug marker 보존.
        // (ADR-912 Avatar slice — internal leaf 어댑터는 semantic prop 을 명시적으로 받아야 함)
        propPassthrough: ["size"],
    },
    skiaPrimitive: "avatar",
};
//# sourceMappingURL=Avatar.binding.js.map