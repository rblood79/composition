 ...
 */
import type { ComponentRuleSize, ComponentRuleStructure, CompositionDocument } from "../../types/composition-document.types";
/**
 ...
 */
export declare const CATALOG_LAYOUT_STYLES: Record<import("@composition/specs").LayoutToken, Record<string, string>>;
...
export declare function resolveCatalogStructure(type: string, doc?: CompositionDocument | null): ComponentRuleStructure | undefined;
/**
 ...
 */
export declare function resolveCatalogContainerBase(type: string, doc?: CompositionDocument | null): Record<string, string | number>;
/**
 ...
 */
export declare function resolveCatalogContainerVariants(type: string, props: Record<string, unknown>, doc?: CompositionDocument | null): ResolvedCatalogContainerVariants;
/**
 ...
 */
export declare function resolveCatalogSizeField(type: string, size: string, field: keyof ComponentRuleSize, doc?: CompositionDocument | null): ComponentRuleSize[keyof ComponentRuleSize] | undefined;
//# sourceMappingURL=resolveCatalogContainer.d.ts.map