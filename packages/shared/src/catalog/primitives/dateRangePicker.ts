...
export const dateRangePickerPrimitiveBinding: PrimitiveBinding<
  DateRangePickerCanonicalProps,
...
> = {
  ...
  props: {
    accepts: dateRangePickerAccepts,
  },
  toRacProps: toDateRangePickerRacProps,
  skiaPrimitive: { kind: "date-range-picker" },
};

export const dateRangePickerInspectorThemeValues = {
  sizes: {
    DateRangePicker: BUTTON_SIZE_VALUES,
  },
};
