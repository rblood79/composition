 ...
 */
function primitiveEntry(type, family, cutover, panel) {
 ...
 */
const FAMILY_1_CUTOVER = "catalog";
const FAMILY_1_ENTRIES = [
 ...
 */
const FAMILY_2_CUTOVER = "catalog";
const FAMILY_2_ENTRIES = [
 ...
 */
const FAMILY_3_CUTOVER = "catalog";
const FAMILY_3_ENTRIES = [
 ...
 */
const FAMILY_4_CUTOVER = "catalog";
const FAMILY_4_ENTRIES = [
 ...
 */
const FAMILY_5_CUTOVER = "catalog";
const FAMILY_5_ENTRIES = [
 ...
 */
const FAMILY_6_CUTOVER = "catalog";
const FAMILY_6_ENTRIES = [
 ...
 */
const FAMILY_7_CUTOVER = "catalog";
const FAMILY_7_ENTRIES = [
 ...
 */
function nativeEntry(type, panel) {
    return {
        kind: "native",
        type,
...
const CATALOG_BY_TYPE = new Map(componentCatalog.map((e) => [e.type, e]));
 ...
 */
export function getPanelMeta(type) {
 ...
 */
export function getCatalogDefaultProps(type) {
