...
export type ComponentFamily = "primitives" | "fields" | "selection" | "collections" | "tree-table" | "overlays" | "date-color" | "composition-native";
/**
 ...
 */
export type InspectorFieldKind = "boolean" | "enum" | "string" | "string-array" | "number" | "icon" | "variant" | "size" | "fillStyle" | "binding" | "items-manager";
/**
