...
export interface ComponentRule {
     ...
     */
    containerVariants?: Record<string, Record<string, ComponentRuleContainerVariantStyles>>;
    /**
...
export type ComponentRuleLayoutToken = "flex-column" | "flex-row" | "inline-flex" | "grid";
/**
 ...
 */
export type DescendantOverride = DescendantReplaceMode | DescendantChildrenMode | DescendantPatchMode;
/**
 ...
 */
export type MigrationHook = (doc: CompositionDocument, fromVersion: string, toVersion: string) => CompositionDocument;
/**
 ...
 */
export declare function migrate(doc: CompositionDocument, fromVersion: string, toVersion: string): CompositionDocument;
/**
...
//# sourceMappingURL=composition-document.types.d.ts.map