 ...
 */
import type { CanonicalNode, CompositionExtension, CompositionDocument, DescendantOverride, SerializedAction, SerializedEvent } from "./composition-document.types";
/**
...
export interface CanonicalDocumentActions {
     ...
     */
    updateNodeExtension(nodeId: string, patch: Partial<CompositionExtension>): void;
    /**
     ...
     */
    moveNode(nodePath: string, targetParentPath: string | null, index: number): void;
    /**
     ...
     */
    appendDescendantChild(refPath: string, descendantPath: string, child: CanonicalNode): void;
    /**
     * 활성 document 의 refPath (RefNode) `descendants[descendantPath].children`
     * 내부 child 를 index 로 재정렬.
     */
    moveDescendantChild(refPath: string, descendantPath: string, childPath: string, index: number): void;
    /**
     ...
     */
    updateDescendant(refPath: string, descendantPath: string, value: DescendantOverride): void;
    /**
...
//# sourceMappingURL=composition-document-actions.types.d.ts.map