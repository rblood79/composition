...
// FLEX_FIELD_COUNT=21 필드/노드. off: [basis,w,h,mt,mr,mb,ml,pb_main,pb_cross,
//   min_main,max_main,min_cross,max_cross,content_main,content_cross,grow,shrink,
//   align_self,overflow_main,content_min_main,margin_auto_mask]
// ─────────────────────────────────────────────────────────────────────────────
...
fn flex_item(basis: f32, cross: f32, grow: f32, shrink: f32) -> [f32; FLEX_FIELD_COUNT] {
    [
        basis, // 0 flex_basis
        basis, // 1 width(main)
