...
export const LUCIDE_ICON_DATA: Record<string, LucideIconData> = {
  ...
  album: {
    paths: [
      "M11 3 L11 11 L14 8 L17 11 L17 3",
  ...
  "bluetooth-connected": {
    paths: ["m7 7 10 10-5 5V2l5 5L7 17", "M18 12L21 12", "M3 12L6 12"],
  },
  "bluetooth-off": {
  ...
  "circle-divide": {
    paths: ["M8 12L16 12", "M12 16L12 16", "M12 8L12 8"],
    circles: [{ cx: 12, cy: 12, r: 10 }],
  },
  "circle-dollar-sign": {
  ...
  crosshair: {
    paths: ["M22 12L18 12", "M6 12L2 12", "M12 6L12 2", "M12 22L12 18"],
    circles: [{ cx: 12, cy: 12, r: 10 }],
  },
  crown: {
    paths: [
  ...
  currency: {
    paths: ["M3 3L6 6", "M21 3L18 6", "M3 21L6 18", "M21 21L18 18"],
  ...
  "dollar-sign": {
    paths: ["M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6", "M12 2L12 22"],
  },
  donut: {
    paths: [
  ...
  "git-pull-request-draft": {
    paths: ["M18 6V5", "M18 11v-1", "M6 9L6 21"],
    circles: [
      { cx: 18, cy: 18, r: 3 },
      { cx: 6, cy: 6, r: 3 },
    ],
  ...
  "git-pull-request": {
    paths: ["M13 6h3a2 2 0 0 1 2 2v7", "M6 9L6 21"],
    circles: [
      { cx: 18, cy: 18, r: 3 },
      { cx: 6, cy: 6, r: 3 },
    ],
  ...
  "locate-fixed": {
    paths: ["M2 12L5 12", "M19 12L22 12", "M12 2L12 5", "M12 19L12 22"],
    circles: [
      { cx: 12, cy: 12, r: 7 },
      { cx: 12, cy: 12, r: 3 },
    ],
  ...
  "shield-cog-corner": {
    ...
    circles: [{ cx: 17.695, cy: 17.695, r: 3 }],
  },
  "shield-cog": {
    paths: [
    ...
    circles: [{ cx: 12.077, cy: 11.695, r: 3 }],
  },
  "shield-ellipsis": {
    paths: [
      "M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",
  ...
  swords: {
    paths: [
      ...
      "M7 17L4 20",
      "M3 19L5 21",
      "M14.5 17.5 L3 6 L3 3 L6 3 L17.5 14.5",
      "M14.5 6.5 L18 3 L21 3 L21 6 L17.5 9.5",
    ],
  },
  syringe: {
    paths: [
  ...
  timer: {
    paths: ["M10 2L14 2", "M12 14L15 11"],
    circles: [{ cx: 12, cy: 14, r: 8 }],
  },
  "toggle-left": {
    paths: [
  ...
  "user-minus": {
    paths: ["M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2", "M22 11L16 11"],
    circles: [{ cx: 9, cy: 7, r: 4 }],
  },
  "user-pen": {
    paths: [
  ...
  "zoom-in": {
    paths: ["M21 21L16.65 16.65", "M11 8L11 14", "M8 11L14 11"],
    circles: [{ cx: 11, cy: 11, r: 8 }],
  },
  "zoom-out": {
    paths: ["M21 21L16.65 16.65", "M8 11L14 11"],
    circles: [{ cx: 11, cy: 11, r: 8 }],
  },
};
