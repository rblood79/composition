...
const NAMED_COLOR_TO_CSS: Record<string, string> = {
  ...
  // Chart 시리즈 팔레트 — categorical 은 생성 semantic-palette.css, accent 는 preview-system.css
  "chart-categorical-1": "var(--chart-categorical-1)",
  "chart-categorical-2": "var(--chart-categorical-2)",
  "chart-categorical-3": "var(--chart-categorical-3)",
  "chart-categorical-4": "var(--chart-categorical-4)",
  "chart-categorical-5": "var(--chart-categorical-5)",
  "chart-categorical-6": "var(--chart-categorical-6)",
  "chart-categorical-7": "var(--chart-categorical-7)",
  "chart-categorical-8": "var(--chart-categorical-8)",
  "chart-accent-1": "var(--chart-accent-1)",
  "chart-accent-2": "var(--chart-accent-2)",
  "chart-accent-3": "var(--chart-accent-3)",
  "chart-accent-4": "var(--chart-accent-4)",
  blue: "var(--hue-blue)",
