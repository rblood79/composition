...
body = '''<div class="sheet" style="gap:15px">
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:22px;flex-grow:1;min-height:0">
    ...
    <div class="stack" style="min-height:0">
      <div class="plab b"><b>중첩 경고</b><span>끌어놓기</span></div>
      <div class="fr" style="flex-grow:1;min-height:0">
        <div class="canv">
      ...
      <p style="margin:0;font-size:11.5px;line-height:1.5;color:var(--ink-2)">막지 않는다. 가까운 유효한 부모에 넣고 되돌릴 길을 준다.</p>
    </div>
  ...
  <div class="verd">
    ...
    <div class="v w"><h3>가장 큰 리스크</h3><p>중첩 경고에서 끌어놓기를 <b>거부</b>하면 좌절을 부른다. 옮기고 되돌릴 길을 주는 쪽이 옳다.</p></div>
    <div class="v f"><h3>착수 순서</h3><p>스크럽 미리보기가 가장 싸고 체감이 크다. 기본 간격은 측정 한 건이 먼저다. 중첩 경고는 결정을 받고 나서.</p></div>
  </div>
</div>'''
