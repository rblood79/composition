...
/**
 * ADR-144 Phase 7 Wave C — ComboBoxPropertyEditor static contract.
 *
 * Sibling 의 SelectPropertyEditor 와 동일 mode 분기 패턴. resolved-tree mode 2 의
 * slot add/remove UI 는 공통 `ResolvedTreeSlotEditor` 로 위임.
 */

const EDITOR_PATH = resolve(__dirname, "..", "ComboBoxPropertyEditor.tsx");

describe("ADR-144 Wave C — ComboBoxPropertyEditor", () => {
