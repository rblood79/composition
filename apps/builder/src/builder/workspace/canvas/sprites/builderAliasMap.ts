 ...
 * (factory/specs 전수 grep) → 신규 생성 경로 없음. 과거 직렬화 TabBar/Switcher 노드는 canonical
 * hydration 시 tagToType → "ToggleButtonGroup" 1회 정규화로 흡수 (Switcher cleanup, RAC
 * ToggleButtonGroup 표준 복귀 — adapters/canonical/tagRename.ts
 * isLegacySwitcherOrTabBarForToggleButtonGroup). 잔여 7 sub-part alias
