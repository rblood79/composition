...
describe("buildPageTitleBounds — 헤더 띠 전체가 드래그 히트 영역", () => {
  const measured = { titleWidth: 60, textX: 8, textTop: -23, textHeight: 12 };

  it("zoom 1: sceneRect 는 (x, y-33, width, 32) — 페이지와 1px 간격, textScene* 는 글리프 box", () => {
