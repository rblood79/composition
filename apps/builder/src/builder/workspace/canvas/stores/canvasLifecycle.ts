 ...
 * 캔버스 표면의 수명주기 상태.
 *
 * 구 렌더 동기화 버전 필드와 mismatch selector는 삭제됐다 (2026-08-15).
 * store 렌더 버전과 별도 렌더러의 확인 응답을 대조하던 프로토콜인데,
 * `incrementRenderVersion` 의 호출부가 0건이라 `renderVersion`
 * 이 0 에 머물렀고, 유일한 sync 호출부는 그 0 을 그대로 되비추고
