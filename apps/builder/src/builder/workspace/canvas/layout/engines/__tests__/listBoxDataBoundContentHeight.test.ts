 ...
 * (ADR-923 r20m1 뒤 sample fallback 없음 — 과거엔 3-item 기본값 fallback 을 반환해 scene 의
 * sample(10행) + hatch(remainder) totalRows 투영과 어긋났고, enrich 가 owner 를 3-item 으로 고정해
 * 투영된 rowsGroup 이 clip 됐다 — Hard Constraint 2 배치 진실성 위반).
 *
