...
export interface TranslationKeys {
  ...
  history: {
    ...
    entryData: string;
    entryDataCount: string;
    entryDataCell: string;
    entryDataRowsInsert: string;
    entryDataRowsRemove: string;
    entryDataRowsReplace: string;
    entryDataFieldAdd: string;
    entryDataFieldRename: string;
    entryDataFieldUpdate: string;
    entryDataFieldRemove: string;
    entryDataCollectionCreate: string;
  ...
  propertiesPanel: {
    ...
    emptyDescription: string;
    stateSection: string;
    stateVisibleElement: string;
    stateVisiblePage: string;
    stateImplicitTitle: string;
    stateImplicitHint: string;
    stateImplicitRac: string;
    ...
    stateType: string;
    stateDefault: string;
    stateUsageCount: string;
    stateNameConflict: string;
    stateNameInvalid: string;
  ...
  chart: {
    ...
    columnsUnsupported: string;
    typeUnavailableInColumns: string;
    colorBySeriesNote: string;
    seriesSettings: string;
    seriesLabel: string;
    seriesColor: string;
    defaultColor: string;
    dormantSeries: string;
    seriesUnavailable: string;
    seriesPreviewHint: string;
    pinToInstance: string;
    numberFormat: string;
    formatAuto: string;
    ...
    localeKoKR: string;
    budgetHint: string;
    budgetModeWindow: string;
    budgetModeAggregate: string;
    budgetModeExtrema: string;
    budgetModeOthers: string;
    budgetFits: string;
    budgetOverflow: string;
    overflowAuto: string;
    overflowWindow: string;
    overflowAggregate: string;
    overflowExtrema: string;
    overflowOthers: string;
    overflowUnsupported: string;
    budgetAggregate: string;
    aggregateSum: string;
    aggregateMean: string;
    aggregateMax: string;
    aggregateMin: string;
    budgetAxis: string;
    axisAuto: string;
