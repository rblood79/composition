...
> = {
  "ko-KR": {
    ...
    "styles.transform.sizeMode.parent": "부모 비율",
    "styles.transform.sizeMode.vw": "화면 기준 (vw)",
    "styles.transform.sizeMode.vh": "화면 기준 (vh)",
    "styles.transform.sizeMode.reset": "초기화",
    "styles.transform.sizeMode.fitTrigger": "Fit",
  ...
  "en-US": {
    ...
    "styles.transform.sizeMode.vw": "Viewport (vw)",
    "styles.transform.sizeMode.vh": "Viewport (vh)",
