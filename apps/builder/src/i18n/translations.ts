...
const koKR: TranslationKeys = {
  ...
  propertiesPanel: {
    ...
    slotEnable: "슬롯 켜기",
    slotDisable: "슬롯 끄기",
    itemRolesSection: "항목 역할",
    cardFieldsSection: "카드 필드",
    itemOriginSection: "항목 원본",
    itemOriginNotice: "이 원본을 쓰는 카드 전체에 적용됩니다.",
    itemRoleRequired: "필수",
    itemRoleAdd: "역할 추가",
    itemRoleIcon: "아이콘",
    itemRoleAvatar: "아바타",
    itemRoleLabel: "레이블",
    itemRoleDescription: "설명",
    itemRoleShortcut: "단축키",
    roleInstanceOrigin: "인스턴스 · 원본",
    stateVariantSelected: "선택됨",
    stateVariantUnselected: "선택 안 됨",
  ...
  navigator: {
    ...
    addLayout: "레이아웃 추가",
    noLayouts: "사용 가능한 레이아웃이 없습니다",
    selectLayout: "레이아웃을 선택하면 요소가 표시됩니다",
    noElements: "이 레이아웃에 요소가 없습니다",
    layers: "레이어",
    collapseTree: "트리 접기",
    searchPages: "페이지 검색",
    pageSettings: "페이지 설정",
  ...
  themes: {
    ...
    rename: "이름 변경",
    delete: "삭제",
    deleteLast: "마지막 테마는 삭제할 수 없습니다",
    activate: "활성화",
    active: "활성",
    name: "이름",
    tokens: "토큰 재정의",
    tokensEmpty: "재정의 없음 — 프리셋 값을 사용합니다",
    category: "분류",
    key: "키",
    value: "값",
    addOverride: "재정의 추가",
    reset: "초기화",
    invalidValue: "값이 유효하지 않습니다",
    catColor: "색상",
    catTypography: "타이포그래피",
    catRadius: "반경",
    catBorder: "테두리 폭",
    catShadow: "그림자",
    catFocus: "포커스",
...
const enUS: TranslationKeys = {
  ...
  propertiesPanel: {
    ...
    itemRolesSection: "Item roles",
    cardFieldsSection: "Card fields",
    itemOriginSection: "Item origin",
    itemOriginNotice: "Changes apply to every card that uses this origin.",
    itemRoleRequired: "Required",
    itemRoleAdd: "Add role",
    itemRoleIcon: "Icon",
    itemRoleAvatar: "Avatar",
    itemRoleLabel: "Label",
    itemRoleDescription: "Description",
    itemRoleShortcut: "Shortcut",
    roleInstanceOrigin: "Instance · Origin",
    stateVariantSelected: "Selected",
    stateVariantUnselected: "Unselected",
  ...
  navigator: {
    ...
    selectLayout: "Select a layout to view elements",
    noElements: "No elements in this layout",
    layers: "Layers",
  ...
  themes: {
    title: "Theme",
    list: "Themes",
    add: "Add theme (duplicate active)",
    duplicate: "Duplicate",
    rename: "Rename",
    delete: "Delete",
    deleteLast: "The last theme can't be deleted",
    activate: "Make active",
    active: "Active",
    name: "Name",
    tokens: "Token overrides",
    tokensEmpty: "No overrides — preset values apply",
    category: "Category",
    key: "Key",
    value: "Value",
...
> = {
  "ko-KR": {
    ...
    "styles.transform.ratio.lockDescription":
      "모든 화면 크기에 적용됩니다. Width 를 기준으로 Height 를 자동 계산합니다.",
    "styles.transform.sizeMode.fixed": "고정",
    "styles.transform.sizeMode.fill": "채우기",
    "styles.transform.sizeMode.fitContent": "내용 맞춤",
    "styles.transform.sizeMode.parent": "부모",
    "styles.transform.sizeMode.vw": "뷰포트",
    "styles.transform.sizeMode.vh": "뷰포트",
    "styles.transform.sizeMode.reset": "초기화",
    "styles.transform.sizeMode.ratioTrigger": "자동(비율)",
    "styles.transform.sizeMode.groupBasic": "크기 방식",
    "styles.transform.sizeMode.groupRelative": "상대 크기",
    "styles.transform.ratio.dependentAxis":
      "Ratio 잠금을 해제하면 이 축을 직접 편집할 수 있습니다.",
    "styles.transform.computedSize": "계산된 크기",
    "styles.transform.notMeasured": "미측정",
    "styles.transform.fillWeightHint": "숫자는 채우기 가중치입니다",
    "styles.transform.ratio.error.selection":
      "선택이 변경되었습니다. 다시 시도하세요.",
    "styles.transform.ratio.error.target": "선택 대상을 찾을 수 없습니다.",
    "styles.transform.ratio.error.geometry":
      "아직 크기가 계산되지 않았습니다. 레이아웃을 기다리거나 Ratio preset 을 선택하세요.",
    ...
    "properties.icon": "아이콘",
    "properties.text": "텍스트",
    "properties.applyLayout": "레이아웃 적용",
    "properties.noLayout": "레이아웃 없음",
    "properties.selectReusableLayout":
      "이 페이지에 적용할 재사용 레이아웃을 선택하세요",
    "properties.removeLayoutFromPage": "이 페이지에서 레이아웃 제거",
    "properties.removeLayout": "레이아웃 제거",
    "properties.name": "이름",
    "properties.role": "역할",
    ...
    "properties.endpoint": "엔드포인트",
    "properties.chunkSize": "청크 크기 (바이트)",
    "properties.parallelUploads": "동시 업로드 수",
    "properties.retryDelays": "재시도 간격 (ms)",
    "properties.maxFileSize": "최대 파일 크기 (바이트)",
    "properties.autoProceed": "선택 즉시 업로드",
    "properties.showPreview": "미리보기 표시",
  ...
  "en-US": {
    ...
    "styles.transform.sizeMode.fixed": "Fixed",
    "styles.transform.sizeMode.fill": "Fill",
    "styles.transform.sizeMode.fitContent": "Fit content",
    "styles.transform.sizeMode.parent": "Parent",
    "styles.transform.sizeMode.vw": "Viewport",
    "styles.transform.sizeMode.vh": "Viewport",
    "styles.transform.sizeMode.reset": "Reset",
    "styles.transform.sizeMode.ratioTrigger": "Auto (ratio)",
    "styles.transform.sizeMode.groupBasic": "Size mode",
    "styles.transform.sizeMode.groupRelative": "Relative size",
    "styles.transform.ratio.dependentAxis":
      "Unlock the ratio to edit this axis.",
    "styles.transform.computedSize": "Computed size",
    "styles.transform.notMeasured": "not measured",
    "styles.transform.fillWeightHint": "The number is the fill weight",
    "styles.transform.ratio.error.selection": "Selection changed. Try again.",
    "styles.transform.ratio.error.target": "Selected element not found.",
    "styles.transform.ratio.error.geometry":
    ...
    "properties.applyLayout": "Apply Layout",
    "properties.noLayout": "No Layout",
    "properties.selectReusableLayout": "Select a reusable layout for this page",
    "properties.removeLayoutFromPage": "Remove layout from this page",
    "properties.removeLayout": "Remove Layout",
    ...
    "properties.chunkSize": "Chunk Size (bytes)",
    "properties.parallelUploads": "Parallel Uploads",
    "properties.retryDelays": "Retry Delays (ms)",
    "properties.maxFileSize": "Max File Size (bytes)",
    "properties.autoProceed": "Auto Proceed",
    "properties.showPreview": "Show Preview",
