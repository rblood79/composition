...
const koKR: TranslationKeys = {
  chart: {
    ...
    step: "계단",
    showDots: "점 표시",
    showValueLabels: "값 레이블 표시",
    labelContent: "레이블 내용",
    categoryName: "범주 이름",
    colorBy: "색상 구분",
    palette: "팔레트",
    paletteCategorical: "범주형",
    paletteMono: "단색",
    innerRadius: "내부 반지름 (%)",
    gridType: "격자 모양",
    polygon: "다각형",
    ...
    endAngle: "끝 각도 (도)",
    showTotal: "합계 표시",
    showSpokes: "중심 연결선 표시",
    gridRings: "동심 격자 수 (0=자동)",
    fillGrid: "격자 채우기",
    fillArea: "영역 채우기 (레이더)",
    showTooltip: "툴팁 표시",
    showAxis: "축 표시",
    ...
    animation: "애니메이션",
    animationDelay: "애니메이션 지연 (ms)",
    animationDuration: "애니메이션 시간 (ms)",
    animationEasing: "애니메이션 속도 변화",
    preset: "프리셋",
    custom: "사용자 지정",
    default: "기본",
    dots: "점 표시",
    donut: "도넛",
    donutTotal: "합계가 있는 도넛",
    linesOnly: "선만 표시",
    half: "반원",
    total: "합계",
    none: "없음",
    ...
    valueFields: "값 필드",
    addField: "필드 추가",
    chooseFields: "값 필드 선택",
    sameUnitHint: "같은 단위의 값을 가진 필드를 선택하세요.",
    moveUp: "위로",
    moveDown: "아래로",
    rowActions: "작업",
    missingField: "원본에 없음",
    ...
    currencyCode: "통화 코드",
    percentUnit: "입력 단위",
    unitRatio: "비율 (0.25 = 25%)",
    unitPoints: "퍼센트 값 (25 = 25%)",
    formatHint: "형식은 라벨·축·툴팁 문자열만 바꿉니다.",
    ...
    scaleTime: "시간 (날짜 간격)",
    scaleLinear: "숫자 (값 간격)",
    timeOnlyLineArea: "시간축은 선·영역·산점도 차트에서만 씁니다.",
  ...
  ai: {
    ...
    suggestComponentFeatures: "컴포넌트 기능",
    suggestCommonEdits: "공통 편집",
    localActionDone: "완료: {goal}. 적용 결과를 확인했습니다.",
    localActionFailed:
      "작업을 완료하지 못했습니다. 선택과 현재 상태를 확인한 뒤 다시 시도해 주세요.",
  ...
  propertiesPanel: {
    ...
    overridesLegend: "재정의",
    attributes: "속성",
    classNamePlaceholder: "예: hero-title",
    ariaLabelPlaceholder: "예: 업로드 진행률",
    slotSection: "슬롯",
    slotStatus: "상태",
    slotInactive: "비활성",
    slotRecommendations: "추천 {count}개",
    slotEnable: "슬롯 켜기",
    slotDisable: "슬롯 끄기",
  ...
  workspace: {
    ...
    resizeCompare: "CSS / Canvas 비교 분할 크기 조절",
  ...
  datatable: {
    ...
    methodEmpty: "빈 테이블",
    methodPreset: "프리셋",
    dropFileHint: "CSV · JSON 파일을 끌어다 놓거나 클릭",
    clearFile: "파일 제거",
    methodPaste: "붙여넣기",
    methodFile: "CSV / JSON",
    methodApi: "API 에서",
    ...
    fieldLabel: "레이블",
    fieldAddTitle: "새 필드",
    fieldNamePlaceholder: "필드 이름 · Enter",
    ...
    apiValuePlaceholder: "값",
    apiRemoveRow: "이 줄 삭제",
    apiBodyType: "본문 형식",
    apiBodyPlaceholder: "{ }",
    apiAuthType: "인증",
    apiAuthNone: "없음",
    apiAuthBearer: "Bearer 토큰",
    ...
    apiAuthUnset: "미설정",
    apiResponseStatus: "상태",
    apiResponseTime: "시간",
    apiResponseSize: "크기",
    apiResponsePretty: "정렬",
    apiResponseRaw: "원본",
    apiResponseSchema: "스키마",
    apiResponseView: "응답 보기",
    apiResponseEmpty: "보내기 를 눌러 응답을 봅니다.",
    apiSchemaPath: "데이터 경로",
    apiSchemaCandidate: "{path} · {count}행",
    apiSchemaNoArray: "응답에서 행 배열을 찾지 못했습니다.",
    ...
    fieldKeyExists: '필드 key "{key}" 는 비었거나 이미 있습니다',
    deleteTitle: "삭제",
    deleteMessage: '"{name}" 을(를) 삭제할까요? 되돌릴 수 없습니다.',
    apiRequest: "요청",
    apiUrl: "URL",
    apiMethod: "메서드",
    apiName: "이름",
    apiNameAuto: "URL 에서 자동 제안",
    apiCreateHint: "만들면 바로 한 번 실행해 응답 스키마를 확인할 수 있습니다.",
    createApi: "API 만들기",
    ...
    filterRows: "행 필터링…",
    filterClear: "필터 지우기",
    presetCategory: "프리셋 분류",
    rowCount: "행 수",
    generateOptions: "생성 조건",
    seed: "시드",
    seedPlaceholder: "비우면 무작위…",
    seedHint: "같은 시드는 같은 행을 만듭니다 (오늘 날짜 기준).",
    blankRate: "빈 값 %",
    sampleData: "샘플 데이터:",
    countUnit: "개",
...
const enUS: TranslationKeys = {
  chart: {
    ...
    dataMode: "Series Source",
    modeGroup: "Group Field",
    modeColumns: "Value Columns",
    valueFields: "Value Fields",
    addField: "Add Field",
    chooseFields: "Choose value fields",
    sameUnitHint: "Pick fields that share the same unit.",
    moveUp: "Move Up",
    moveDown: "Move Down",
    rowActions: "actions",
    missingField: "Missing in source",
    fieldTypeNumber: "numeric",
    fieldTypeText: "textual",
    fieldTypeUnknown: "unknown type",
    columnsUnsupported:
      "Value columns are not available for pie and radial charts.",
    typeUnavailableInColumns: "Not available in value-columns mode",
    colorBySeriesNote: "Bars will be colored by series.",
    seriesSettings: "Series Settings",
    seriesLabel: "Display Name",
    seriesColor: "Color",
    defaultColor: "Default",
    dormantSeries: "Hidden series settings",
    seriesUnavailable:
      "Series names and colors do not apply when categories are colored.",
    seriesPreviewHint:
      "Names and colors change the legend and tooltip, not the source rows.",
    pinToInstance: "Keep this list on this instance",
    numberFormat: "Number Format",
    formatAuto: "Auto (default)",
    ...
    percentUnit: "Input Unit",
    unitRatio: "Ratio (0.25 = 25%)",
    unitPoints: "Points (25 = 25%)",
    formatHint: "Format changes labels, axis and tooltip text only.",
    ...
    scaleLinear: "Number (value spacing)",
    timeOnlyLineArea:
      "The time axis is for line, area and scatter charts only.",
  ...
  ai: {
    ...
    suggestComponentFeatures: "Component features",
    suggestCommonEdits: "Common edits",
    localActionDone: "Completed: {goal}. The applied result was verified.",
    localActionFailed:
      "The action could not be completed. Check the selection and current state, then try again.",
  ...
  propertiesPanel: {
    ...
    overridesLegend: "Overrides",
    attributes: "Attributes",
    classNamePlaceholder: "e.g. hero-title",
    ariaLabelPlaceholder: "e.g. Upload progress",
    slotSection: "Slot",
    slotStatus: "Status",
    slotInactive: "Inactive",
    slotRecommendations: "{count} recommendations",
  ...
  workspace: {
    ...
    resizeCompare: "Resize the CSS / Canvas compare split",
  ...
  datatable: {
    ...
    startMethod: "Start from",
    methodEmpty: "Empty table",
    methodPreset: "Preset",
    dropFileHint: "Drop a CSV or JSON file, or click",
    ...
    fieldNamePlaceholder: "Field name · Enter",
    ...
    apiAuthApiKey: "API Key",
    apiAuthIn: "In",
    apiAuthInHeader: "Header",
    apiAuthInQuery: "Query",
    ...
    apiResponseSize: "Size",
    apiResponsePretty: "Pretty",
    apiResponseRaw: "Raw",
    apiResponseSchema: "Schema",
    apiResponseView: "Response view",
    apiResponseEmpty: "Press Send to see the response.",
    apiSchemaPath: "Data path",
    apiSchemaCandidate: "{path} · {count} rows",
    apiSchemaNoArray: "No row array found in the response.",
    ...
    fieldKeyExists: 'Field key "{key}" is empty or already exists',
    deleteTitle: "Delete",
    ...
    seed: "Seed",
    seedPlaceholder: "Empty for random…",
    seedHint: "The same seed produces the same rows (relative to today).",
    blankRate: "Blank %",
...
> = {
  "ko-KR": {
    ...
    "sections.collapseAll": "모든 섹션 접기",
    "sections.expandAll": "모든 섹션 펼치기",
    ...
    "styles.position.title": "위치",
    "styles.layout.linkSides": "4방향 연동",
    "styles.layout.unlinkSides": "4방향 연동 해제",
    ...
    "styles.typography.align": "정렬",
    "styles.typography.verticalAlignShort": "세로",
    "styles.typography.decoration": "장식",
    "styles.typography.case": "대소문자",
    "styles.typography.noDecoration": "장식 없음",
    "styles.typography.noTransform": "변환 없음",
    ...
    "styles.typography.align.left": "왼쪽 정렬",
    "styles.typography.align.center": "가운데 정렬",
    "styles.typography.align.right": "오른쪽 정렬",
    "styles.typography.valign.top": "위쪽 정렬",
    "styles.typography.valign.middle": "가운데 정렬 (수직)",
    "styles.typography.valign.bottom": "아래쪽 정렬",
    "styles.typography.decoration.overline": "윗줄",
    ...
    "styles.typography.transform.lowercase": "소문자",
    "styles.typography.transform.capitalize": "첫 글자 대문자",
    "styles.layout.direction.block": "블록",
    "styles.layout.direction.row": "가로",
    "styles.layout.direction.column": "세로",
    "styles.layout.justify.spaceAround": "둘레 균등",
    "styles.layout.justify.spaceBetween": "양끝 정렬",
    "styles.layout.justify.spaceEvenly": "간격 균등",
    "styles.layout.wrapOption.wrap": "줄바꿈",
    "styles.layout.wrapOption.wrapReverse": "역방향 줄바꿈",
    "styles.layout.wrapOption.nowrap": "줄바꿈 없음",
    "styles.layout.alignment.topLeft": "왼쪽 위",
    "styles.layout.alignment.topCenter": "가운데 위",
    "styles.layout.alignment.topRight": "오른쪽 위",
    "styles.layout.alignment.middleLeft": "왼쪽 가운데",
    "styles.layout.alignment.middleCenter": "정가운데",
    "styles.layout.alignment.middleRight": "오른쪽 가운데",
    "styles.layout.alignment.bottomLeft": "왼쪽 아래",
    "styles.layout.alignment.bottomCenter": "가운데 아래",
    "styles.layout.alignment.bottomRight": "오른쪽 아래",
    ...
    "styles.appearance.shadowLayerActions": "그림자 레이어 작업",
    "styles.appearance.addShadowLayer": "레이어 추가",
    "styles.appearance.removeShadowLayer": "레이어 제거",
    "styles.appearance.insetShadowLayer": "안쪽 그림자로",
    "styles.appearance.outerShadowLayer": "바깥 그림자로",
    "styles.appearance.opacity": "불투명도",
    "styles.appearance.background": "배경",
    "styles.border.title": "테두리",
    "styles.border.radius": "반경",
    "styles.border.style": "스타일",
    "styles.border.none": "테두리 없음",
    "styles.border.solid": "실선",
    "styles.border.dashed": "파선",
    "styles.border.dotted": "점선",
    "styles.border.widthPresets": "테두리 너비 프리셋",
    "styles.border.radiusPresets": "테두리 반경 프리셋",
    "styles.border.cornerRadii": "코너별 반경",
    "styles.colorPicker.document": "문서",
    "styles.colorPicker.theme": "테마",
    "styles.colorPicker.accent": "강조색",
    "styles.colorPicker.neutral": "중립색",
    "styles.colorPicker.noDocumentColors": "아직 쓰인 색이 없습니다",
    "styles.border.sides": "변",
    "styles.border.allSides": "전체",
    "styles.border.leftSide": "왼쪽",
    "styles.border.rightSide": "오른쪽",
    "styles.border.topSide": "위쪽",
    "styles.border.bottomSide": "아래쪽",
    "styles.border.sidesUnsupported": "변별 너비는 실선·파선·점선에서만",
    "styles.border.skiaApproximation": "Skia 근사",
    "styles.border.corners": "코너",
    "styles.border.topLeftRadius": "좌상 반경",
    "styles.border.topRightRadius": "우상 반경",
    "styles.border.bottomRightRadius": "우하 반경",
    "styles.border.bottomLeftRadius": "좌하 반경",
    "styles.appearance.borderTopLeftRadius": "좌상 반경",
    "styles.appearance.borderTopRightRadius": "우상 반경",
    "styles.appearance.borderBottomRightRadius": "우하 반경",
    "styles.appearance.borderBottomLeftRadius": "좌하 반경",
    "styles.appearance.borderTopWidth": "상단 테두리 너비",
    "styles.appearance.borderRightWidth": "우측 테두리 너비",
    "styles.appearance.borderBottomWidth": "하단 테두리 너비",
    "styles.appearance.borderLeftWidth": "좌측 테두리 너비",
    "styles.effect.title": "효과",
    "styles.effect.boxShadows": "박스 그림자",
    "styles.effect.boxShadowActions": "박스 그림자 작업",
    "styles.effect.shadowPreset": "프리셋",
    "styles.effect.editShadowLayer": "그림자 레이어 편집",
    "styles.effect.shadowColor": "그림자 색",
    "styles.effect.offsetX": "X 오프셋",
    "styles.effect.offsetY": "Y 오프셋",
    "styles.effect.blur": "흐림",
    "styles.effect.spread": "확산",
    "styles.effect.filters": "필터",
    "styles.effect.blurRadius": "흐림 반경",
    "styles.effect.addBlur": "흐림 필터 추가",
    "styles.effect.removeBlur": "흐림 필터 제거",
    "styles.fill.addFill": "채우기 추가",
    "styles.fill.editFill": "채우기 편집",
    "styles.fill.removeFill": "채우기 제거",
    "styles.fill.toggleVisibility": "채우기 표시 전환",
    "styles.fill.noBackground": "배경 없음",
    "styles.fill.opacity": "채우기 불투명도",
    ...
    "properties.behavior": "동작",
    "properties.locale": "로캘",
    "properties.icon": "아이콘",
    "properties.text": "텍스트",
    ...
    "properties.none": "없음",
    "properties.disabled": "비활성",
    "properties.quiet": "조용함",
    "properties.autoFocus": "자동 포커스",
    "properties.labelPosition": "라벨 위치",
    "properties.readOnly": "읽기 전용",
    "properties.invalid": "유효하지 않음",
    "properties.ariaLabel": "ARIA 라벨",
    "properties.description": "설명",
    "properties.placeholder": "자리 표시 텍스트",
    "properties.errorMessage": "오류 메시지",
    "properties.necessityIndicator": "필수 표시",
    "properties.selectionMode": "선택 모드",
    "properties.single": "단일",
    "properties.multiple": "다중",
    "properties.staticColor": "고정 색",
    "properties.black": "검정",
    "properties.white": "흰색",
    "properties.density": "밀도",
    "properties.compact": "조밀",
    "properties.regular": "보통",
    "properties.spacious": "넓게",
    "properties.emphasized": "강조",
    "properties.disallowEmptySelection": "빈 선택 금지",
    "properties.min": "최소",
    "properties.max": "최대",
    "properties.valueLabel": "값 라벨",
    "properties.fillStyle": "채움 스타일",
    "properties.fill": "채움",
    "properties.outline": "윤곽선",
    "properties.subtle": "연하게",
    "properties.selectionStyle": "선택 스타일",
    "properties.checkbox": "체크박스",
    "properties.highlight": "하이라이트",
    "properties.title": "제목",
    "properties.heading": "표제",
    "properties.indicator": "인디케이터",
    "properties.inputType": "입력 유형",
    "properties.password": "비밀번호",
    "properties.search": "검색",
    "properties.tel": "전화",
    "properties.inputMode": "입력 모드",
    "properties.numeric": "숫자",
    "properties.enterKeyHint": "엔터 키 힌트",
    "properties.enter": "입력",
    "properties.done": "완료",
    "properties.go": "이동",
    "properties.next": "다음",
    "properties.previous": "이전",
    "properties.send": "보내기",
    "properties.autoComplete": "자동 완성",
    "properties.autoCorrect": "자동 교정",
    "properties.spellCheck": "맞춤법 검사",
    "properties.pattern": "패턴",
    "properties.target": "대상",
    "properties.sameWindow": "같은 창",
    "properties.newWindow": "새 창",
    "properties.parentFrame": "부모 프레임",
    "properties.topFrame": "최상위 프레임",
    "properties.granularity": "단위",
    "properties.day": "일",
    "properties.hour": "시",
    "properties.minute": "분",
    "properties.second": "초",
    ...
    "properties.heightMode": "높이 모드",
    "properties.fixed": "고정",
    "properties.viewport": "뷰포트",
    "properties.full": "전체",
    "properties.striped": "줄무늬",
    "properties.bordered": "테두리",
    "properties.allowSorting": "정렬 허용",
    "properties.acceptDirectory": "폴더 허용",
    "properties.acceptedFileTypes": "허용 파일 형식",
    "properties.defaultCamera": "기본 카메라",
    "properties.cameraUser": "전면",
    "properties.cameraEnvironment": "후면",
    "properties.allowMultiple": "다중 선택 허용",
    "properties.channel": "채널",
    "properties.colorSpace": "색 공간",
    "properties.hue": "색조",
    "properties.saturation": "채도",
    "properties.brightness": "명도",
    "properties.lightness": "밝기",
    "properties.alpha": "알파",
    "properties.wheelDisabled": "휠 비활성",
    "properties.menuTrigger": "메뉴 트리거",
    "properties.input": "입력",
    "properties.focus": "포커스",
    "properties.manual": "수동",
    "properties.allowCustomValue": "사용자 값 허용",
    "properties.totalPages": "전체 페이지",
    "properties.currentPage": "현재 페이지",
    "properties.rows": "행 수",
    "properties.maxRows": "최대 행",
    "properties.allowsRemoving": "제거 허용",
    "properties.strokeWidth": "획 두께",
    "properties.allowMultipleExpanded": "다중 펼침 허용",
    "properties.expanded": "펼침",
    "properties.imageUrl": "이미지 URL",
    "properties.altText": "대체 텍스트",
    "properties.initials": "이니셜",
    "properties.dotBadge": "점 배지",
    "properties.pulsing": "깜빡임",
    "properties.indeterminate": "미확정",
    "properties.info": "정보",
    "properties.warning": "경고",
    "properties.critical": "위험",
    "properties.informative": "정보",
    "properties.positive": "긍정",
    "properties.notice": "주의",
    "properties.negative": "부정",
    "properties.primary": "기본",
    "properties.secondary": "보조",
    "properties.tertiary": "3차",
    "properties.premium": "프리미엄",
    "properties.surface": "표면",
    "properties.outlined": "윤곽선",
    "properties.selected": "선택됨",
    "properties.submit": "제출",
    "properties.pending": "대기 중",
    "properties.button": "버튼",
    "properties.triggerLabel": "트리거 라벨",
    "properties.menuItems": "메뉴 항목",
    "properties.options": "옵션",
    "properties.items": "항목",
    "properties.tags": "태그",
    "properties.legend": "범례",
    "properties.tooltip": "툴팁",
    "properties.axis": "축",
    "properties.grid": "격자",
    "properties.spokes": "스포크",
    "properties.areaRadar": "영역 (레이더)",
    "properties.valueLabels": "값 라벨",
    "properties.separator": "구분선",
    "properties.nav": "내비게이션",
    "properties.instance": "인스턴스",
    "properties.attributes": "속성",
    "properties.slot": "슬롯",
    "properties.status": "상태",
    "properties.start": "시작",
    "properties.center": "가운데",
    "properties.end": "끝",
    "properties.waterfall": "워터폴",
    "properties.stack": "스택",
    "properties.origin": "원본",
    "properties.clearIcon": "아이콘 지우기",
    ...
    "datatable.dataSource": "데이터 소스",
    "datatable.dataEndpoint": "API 엔드포인트",
    "datatable.endpointNone": "연결 안 함",
    "datatable.executionPolicy": "실행 정책",
    "datatable.policyAuto": "자동",
    "datatable.policyManual": "수동",
    "datatable.policyInterval": "주기 실행",
    "datatable.intervalSeconds": "주기(초)",
    "datatable.policyHintAuto": "미리보기를 열 때 자동으로 실행합니다.",
    "datatable.policyHintManual": "Send·새로고침 버튼으로만 실행합니다.",
    "datatable.policyHintInterval": "설정한 주기마다 자동으로 실행합니다.",
  },
  "en-US": {
    ...
    "styles.position.title": "Position",
    "styles.layout.linkSides": "Link sides",
    "styles.layout.unlinkSides": "Unlink sides",
    ...
    "styles.typography.verticalAlignShort": "Vertical",
    "styles.typography.decoration": "Decoration",
    "styles.typography.case": "Case",
    "styles.typography.noDecoration": "No decoration",
    "styles.typography.noTransform": "No transform",
    ...
    "styles.typography.align.left": "Align left",
    "styles.typography.align.center": "Align center",
    "styles.typography.align.right": "Align right",
    "styles.typography.valign.top": "Vertical align top",
    "styles.typography.valign.middle": "Vertical align middle",
    "styles.typography.valign.bottom": "Vertical align bottom",
    "styles.typography.decoration.overline": "Overline",
    ...
    "styles.typography.transform.lowercase": "Lowercase",
    "styles.typography.transform.capitalize": "Capitalize",
    "styles.layout.direction.block": "Block",
    "styles.layout.direction.row": "Row",
    "styles.layout.direction.column": "Column",
    "styles.layout.justify.spaceAround": "Space around",
    "styles.layout.justify.spaceBetween": "Space between",
    "styles.layout.justify.spaceEvenly": "Space evenly",
    "styles.layout.wrapOption.wrap": "Wrap lines",
    "styles.layout.wrapOption.wrapReverse": "Wrap reverse",
    "styles.layout.wrapOption.nowrap": "No wrap",
    "styles.layout.alignment.topLeft": "Top left",
    "styles.layout.alignment.topCenter": "Top center",
    "styles.layout.alignment.topRight": "Top right",
    "styles.layout.alignment.middleLeft": "Middle left",
    "styles.layout.alignment.middleCenter": "Middle center",
    "styles.layout.alignment.middleRight": "Middle right",
    "styles.layout.alignment.bottomLeft": "Bottom left",
    "styles.layout.alignment.bottomCenter": "Bottom center",
    "styles.layout.alignment.bottomRight": "Bottom right",
    ...
    "styles.appearance.shadowLayerActions": "Shadow layer actions",
    "styles.appearance.addShadowLayer": "Add layer",
    "styles.appearance.removeShadowLayer": "Remove layer",
    "styles.appearance.insetShadowLayer": "Make inset",
    "styles.appearance.outerShadowLayer": "Make outer",
    "styles.appearance.opacity": "Opacity",
    "styles.appearance.background": "Background",
    "styles.border.title": "Border",
    "styles.border.radius": "Radius",
    "styles.border.style": "Style",
    "styles.border.none": "No border",
    "styles.border.solid": "Solid",
    "styles.border.dashed": "Dashed",
    "styles.border.dotted": "Dotted",
    "styles.border.widthPresets": "Border width presets",
    "styles.border.radiusPresets": "Border radius presets",
    "styles.border.cornerRadii": "Corner radii",
    "styles.colorPicker.document": "Document",
    "styles.colorPicker.theme": "Theme",
    "styles.colorPicker.accent": "Accent",
    "styles.colorPicker.neutral": "Neutral",
    "styles.colorPicker.noDocumentColors": "No colors used yet",
    "styles.border.sides": "Sides",
    "styles.border.allSides": "All",
    "styles.border.leftSide": "Left",
    "styles.border.rightSide": "Right",
    "styles.border.topSide": "Top",
    "styles.border.bottomSide": "Bottom",
    "styles.border.sidesUnsupported":
      "Per-side width needs solid, dashed or dotted",
    "styles.border.skiaApproximation": "Skia approximation",
    "styles.border.corners": "Corners",
    "styles.border.topLeftRadius": "Top left radius",
    "styles.border.topRightRadius": "Top right radius",
    "styles.border.bottomRightRadius": "Bottom right radius",
    "styles.border.bottomLeftRadius": "Bottom left radius",
    "styles.appearance.borderTopLeftRadius": "Border Top Left Radius",
    "styles.appearance.borderTopRightRadius": "Border Top Right Radius",
    "styles.appearance.borderBottomRightRadius": "Border Bottom Right Radius",
    "styles.appearance.borderBottomLeftRadius": "Border Bottom Left Radius",
    "styles.appearance.borderTopWidth": "Border Top Width",
    "styles.appearance.borderRightWidth": "Border Right Width",
    "styles.appearance.borderBottomWidth": "Border Bottom Width",
    "styles.appearance.borderLeftWidth": "Border Left Width",
    "styles.effect.title": "Effect",
    "styles.effect.boxShadows": "Box Shadows",
    "styles.effect.boxShadowActions": "Box shadow actions",
    "styles.effect.shadowPreset": "Preset",
    "styles.effect.editShadowLayer": "Edit shadow layer",
    "styles.effect.shadowColor": "Shadow Color",
    "styles.effect.offsetX": "Offset X",
    "styles.effect.offsetY": "Offset Y",
    "styles.effect.blur": "Blur",
    "styles.effect.spread": "Spread",
    "styles.effect.filters": "Filters",
    "styles.effect.blurRadius": "Blur radius",
    "styles.effect.addBlur": "Add blur filter",
    "styles.effect.removeBlur": "Remove blur filter",
    "styles.fill.addFill": "Add fill",
    "styles.fill.editFill": "Edit fill",
    "styles.fill.removeFill": "Remove fill",
    "styles.fill.toggleVisibility": "Toggle fill visibility",
    ...
    "styles.modified.title": "Modified",
    ...
    "properties.quiet": "Quiet",
    "properties.autoFocus": "Auto Focus",
    "properties.labelPosition": "Label Position",
    ...
    "properties.necessityIndicator": "Necessity Indicator",
    "properties.selectionMode": "Selection Mode",
    "properties.single": "Single",
    "properties.multiple": "Multiple",
    "properties.staticColor": "Static Color",
    "properties.black": "Black",
    "properties.white": "White",
    "properties.density": "Density",
    "properties.compact": "Compact",
    "properties.regular": "Regular",
    "properties.spacious": "Spacious",
    "properties.emphasized": "Emphasized",
    "properties.disallowEmptySelection": "Disallow Empty Selection",
    "properties.min": "Min",
    "properties.max": "Max",
    "properties.valueLabel": "Value Label",
    "properties.fillStyle": "Fill Style",
    "properties.fill": "Fill",
    "properties.outline": "Outline",
    "properties.subtle": "Subtle",
    "properties.selectionStyle": "Selection Style",
    "properties.checkbox": "Checkbox",
    "properties.highlight": "Highlight",
    "properties.title": "Title",
    "properties.heading": "Heading",
    "properties.indicator": "Indicator",
    "properties.inputType": "Input Type",
    "properties.password": "Password",
    "properties.search": "Search",
    "properties.tel": "Tel",
    "properties.inputMode": "Input Mode",
    "properties.numeric": "Numeric",
    "properties.enterKeyHint": "Enter Key Hint",
    "properties.enter": "Enter",
    "properties.done": "Done",
    "properties.go": "Go",
    "properties.next": "Next",
    "properties.previous": "Previous",
    "properties.send": "Send",
    "properties.autoComplete": "Auto Complete",
    "properties.autoCorrect": "Auto Correct",
    "properties.spellCheck": "Spell Check",
    "properties.pattern": "Pattern",
    "properties.target": "Target",
    "properties.sameWindow": "Same Window",
    "properties.newWindow": "New Window",
    "properties.parentFrame": "Parent Frame",
    "properties.topFrame": "Top Frame",
    "properties.granularity": "Granularity",
    "properties.day": "Day",
    ...
    "properties.heightMode": "Height Mode",
    ...
    "properties.allowSorting": "Allow Sorting",
    "properties.acceptDirectory": "Accept Directory",
    "properties.acceptedFileTypes": "Accepted File Types",
    "properties.defaultCamera": "Default Camera",
    "properties.cameraUser": "User (Front)",
    "properties.cameraEnvironment": "Environment (Rear)",
    "properties.allowMultiple": "Allow Multiple",
    "properties.channel": "Channel",
    "properties.colorSpace": "Color Space",
    "properties.hue": "Hue",
    "properties.saturation": "Saturation",
    "properties.brightness": "Brightness",
    "properties.lightness": "Lightness",
    "properties.alpha": "Alpha",
    "properties.wheelDisabled": "Wheel Disabled",
    "properties.menuTrigger": "Menu Trigger",
    "properties.input": "Input",
    "properties.focus": "Focus",
    "properties.manual": "Manual",
    "properties.allowCustomValue": "Allow Custom Value",
    "properties.totalPages": "Total Pages",
    "properties.currentPage": "Current Page",
    "properties.rows": "Rows",
    "properties.maxRows": "Max Rows",
    "properties.allowsRemoving": "Allows Removing",
    "properties.strokeWidth": "Stroke Width",
    "properties.allowMultipleExpanded": "Allow Multiple Expanded",
    "properties.expanded": "Expanded",
    "properties.imageUrl": "Image URL",
    "properties.altText": "Alt Text",
    "properties.initials": "Initials",
    "properties.dotBadge": "Dot Badge",
    "properties.pulsing": "Pulsing",
    "properties.indeterminate": "Indeterminate",
    "properties.info": "Info",
    "properties.warning": "Warning",
    "properties.critical": "Critical",
    "properties.informative": "Informative",
    ...
    "properties.areaRadar": "Area (radar)",
    "properties.valueLabels": "Value Labels",
    ...
    "properties.end": "End",
    "properties.waterfall": "Waterfall",
    "properties.stack": "Stack",
    "properties.origin": "Origin",
    "properties.clearIcon": "Clear icon",
    ...
    "datatable.dataSource": "Data source",
    "datatable.dataEndpoint": "API endpoint",
    "datatable.endpointNone": "Not connected",
    "datatable.executionPolicy": "Execution policy",
    "datatable.policyAuto": "Auto",
    "datatable.policyManual": "Manual",
    "datatable.policyInterval": "Interval",
    "datatable.intervalSeconds": "Interval (seconds)",
    "datatable.policyHintAuto": "Runs automatically when the preview opens.",
    "datatable.policyHintManual": "Runs only via the Send/refresh button.",
    "datatable.policyHintInterval":
...
> = {
  "ko-KR": {
    ...
    "ai.localActionDone": (args) =>
      `완료: ${String(args?.goal ?? "")}. 적용 결과를 확인했습니다.`,
    ...
    "propertiesPanel.stateUsageCount": (args) =>
      `사용처 ${String(args?.count ?? 0)}`,
    "propertiesPanel.slotRecommendations": (args) =>
      `추천 ${String(args?.count ?? 0)}개`,
    "propertiesPanel.resetOverride": (args) =>
      `${String(args?.label ?? "")} 재정의 되돌리기`,
    ...
    "aiRuntime.providerError": () =>
      "모델 호출에 실패했습니다. endpoint·모델·키 설정을 확인하세요.",
  ...
  "en-US": {
    ...
    "datatable.apiSaveFailed": (args) =>
      `Save failed: ${String(args?.message ?? "")}`,
    "datatable.importSucceeded": (args) =>
    ...
    "ai.localActionDone": (args) =>
      `Completed: ${String(args?.goal ?? "")}. The applied result was verified.`,
    "ai.suggestionsIntro": (args) =>
    ...
    "propertiesPanel.stateUsageCount": (args) =>
      `Used in ${String(args?.count ?? 0)}`,
    "propertiesPanel.slotRecommendations": (args) =>
      `${String(args?.count ?? 0)} recommendations`,
    "propertiesPanel.resetOverride": (args) =>
      `Reset ${String(args?.label ?? "")} override`,
    "propertiesPanel.stateNameConflict": (args) =>
    ...
    "aiRuntime.providerError": () =>
      "The model call failed. Check the endpoint, model, and key settings.",
    "aiToolError.targetNotFound": (args) =>
