...
3. **AI tool-call 시제 라벨 테이블** + **선택 컨텍스트 칩** + **캔버스 플래시형 변경 표시** — [ADR-134](../../adr/completed/134-ai-assistant-llm-infrastructure-unification.md) 계열로 라우팅 (Proposed). 본 문서에서 별도 후보로 추적하지 않음.
