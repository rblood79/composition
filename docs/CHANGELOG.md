...
- **Fill 레이어 행을 28 그룹 / 안쪽 20 규칙으로** — swatch 16 → 20×20 raised (팝오버 trigger), 불투명도 scrub 28 → 20, 삭제 버튼이 hover 전엔 안 보이던 것 → 눈 토글과 한 액션 그룹 (28 그룹 안 20×20 둘, 항상 보임). Effect 의 Blur 행 scrub 도 20.
