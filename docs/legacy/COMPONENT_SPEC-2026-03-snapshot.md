> **출처**: `docs/COMPONENT_SPEC.md`, 2026-03-03 시점 스냅샷, 2026-09-09 분리. append-only, 재편집 금지.
...
export interface ContainerLayout {
  ...
  alignSelf?:
    "auto" | "flex-start" | "center" | "flex-end" | "stretch" | "start" | "end";
...
export interface TextFieldProps {
  variant?:
    "default" | "primary" | "secondary" | "tertiary" | "error" | "success";
  size?: "sm" | "md" | "lg";
  label?: string;
  description?: string;
  errorMessage?: string;
...
- [React Aria 1.14.0 마이그레이션 기록](REACT_ARIA_MIGRATION_1_14.md)
