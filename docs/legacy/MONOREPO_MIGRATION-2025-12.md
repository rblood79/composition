...
> **폐기 (2026-09-09)**: 2025-12-31 에 끝난 모노레포 전환의 **실행 계획서**다 (Phase 별 `git mv`
> 절차 · 롤백 계획 2,465줄). §1.1 "현재 구조" 가 캔버스를 "Pixi.js 기반" 으로 적고 있는데 PixiJS 는
> ADR-900 통합 Skia 로 대체됐고, 계획에 있던 Storybook · Playwright 설정은 채택되지 않아
> 저장소에 없다. 현행 구조 요약은 [reference/architecture/MONOREPO.md](../reference/architecture/MONOREPO.md).
> 기록 보존용.

> **작성일**: 2025-12-31
> **상태**: ✅ 완료 (Completed) - 2025-12-31
> **관련 문서**: [RENDERING_ARCHITECTURE.md](../../legacy/RENDERING_ARCHITECTURE.md)
