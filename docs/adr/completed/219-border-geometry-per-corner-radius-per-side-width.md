...
6. **HC6 번들** — Builder initial 순증 ≤ 2 KiB gzip, 절대 상한 218 승인값 (1,281,643 / 666,309, 만료 2026-10-13) 안. Preview 순증 0 (DOM leg 변경 없음). **2026-09-14 실측 초과** (Builder +4,012 B · Preview +714 B — 218 상한은 착수 전 panel-ui 반영이 이미 넘긴 상태) → 사용자 판정: 상한을 219 재승인값 Builder ≤ 1,319,829 / Preview ≤ 675,021 B gzip (218 상한 1,281,643 / 666,309 대체, 만료 2026-10-14) 으로 대체. 순증 한도 (Builder 3.5 / Preview 6 KiB) 는 그대로.
