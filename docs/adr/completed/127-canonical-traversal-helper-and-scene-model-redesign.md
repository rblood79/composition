...
> **Superseded in part by [ADR-128](128-cloud-backend-decommission.md) (cloud transport 영향 부분, 2026-05-12)** — canonical traversal helper + scene model 재설계 자체는 유효, 본 ADR 이 cloud transport boundary 정합을 가정한 design 일부는 stale.
