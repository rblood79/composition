...
> **Superseded in part by [ADR-128](128-cloud-backend-decommission.md) (cloud schema 호환 부분, 2026-05-12)** — render input canonical-native contract 자체는 유효, 본 ADR 이 cloud `elements` row schema 호환 보존 명분으로 남긴 fallback 영역은 stale.
