...
- 2026-07-23 — **Phase 2 + Phase 4 근본 수정**: factory standalone→ref + scene node type ref→master 해석(per-gate patch 대신 단일 지점 정본 수정, 사용자 지시). live 검증 — 신규 GridList=ref Instance + Skia 카드 projection 동작 + grid 카드 라벨 정상 렌더.
