...
호출하지 않는 fixture 를 가진다. 단, collections family 전체는 아직 닫지 않았다.
ADR-132 collection 데이터 binding 전체 전환과 Menu/ComboBox/Select/Tabs 잔여 slice 가
다음 진입점이다.
