...
| R5  | 기존 프로젝트의 legacy payload 가 새 렌더러에서 깨진다 — legacy payload 를 가진 기존 프로젝트 전수(100% 노출)가 대상이며, boundary adapter 가 막지 못하면 사용자-가시 영향이 전 프로젝트로 즉시 확산된다                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |   MED    | import/export 호환 adapter 를 boundary 에 유지. canonical resolver round-trip fixture 로 검증                                                                                                                                     |
