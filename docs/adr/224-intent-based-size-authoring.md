...
Accepted — 2026-09-18 (Fill 차단 수리 · Ratio 엔진 경계 · Ratio 복합 명령 UI · Flow→Absolute 복합 명령 · 캔버스 핸들 resize · 다중 선택 Ratio/Absolute · absolute left/top 핸들 반영 — 전체 adapter/출력/Undo · G5/G6 은 미완)
