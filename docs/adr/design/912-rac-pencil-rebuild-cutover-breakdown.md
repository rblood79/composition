...
> | **step 4 — spec 파일 삭제**         | import graph 끊긴 뒤 `*.spec.ts` 124+ 제거 (마지막)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | ⬜ 예정 (선행: step 3 + 사용자 명시 삭제 승인) |
> | **step 5 — 문서/status 정합**       | 각 step breakdown 진행표 갱신(step 동반) + ADR Status 정책(Proposed vs execute-adr 자동 진입 충돌 명시)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | ◐ step 별 동반 진행                            |
