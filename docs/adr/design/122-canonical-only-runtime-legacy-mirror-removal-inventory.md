...
next open contract: none for ADR-122; cloud physical schema removal remains outside this ADR
```
...
| `apps/builder/src/utils/projectSync.ts`, shared export/import utils                                                                                              | `boundary-allowed`            | Cloud/export/import/publish compatibility projection                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | G4     |
