...
2026-09-10 · **round 2 수리 검증 승인 · P0/G0 PASS · P1 이후 미실행**. [상위 ADR](../210-chart-multi-field-series-presentation.md), [대상 조사](../../explanation/research/CHART_EXTENSION_SCOPE_RESEARCH_2026-09.md). 아래 함수/새 필드/파일명은 제안이며 현행 구현으로 인용하지 않는다.
