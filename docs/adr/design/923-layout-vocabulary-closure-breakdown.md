...
| `…/engines/fullTreeLayout.ts`                                                          | 1(r6)·4·5 | 1(r6): `toBatchDisplay` post-order patch union 강제 (Phase 5 제거) · 4: HC1 테스트 대상 · 5: `:1060,1084` 분기 CSS 값 보존, §5.5·blockify 호출·`toBatchDisplay` 삭제 |
