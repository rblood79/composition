...
| [ADR-117](../completed/117-canvaskit-pathbuilder-upgrade.md)                                                                                      | CanvasKit 버전/API 전환은 별도 Implemented 결정                                                                       | backend 계약과 dependency upgrade를 결합하지 않음                                                                                                    |
...
- CanvasKit 0.42.x/PathBuilder 업그레이드 ([ADR-117](../completed/117-canvaskit-pathbuilder-upgrade.md))
