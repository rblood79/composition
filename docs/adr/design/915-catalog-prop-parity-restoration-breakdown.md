...
| P1.5-a contextualHelp     | ⏸ **scope 재판정 대기 (사용자 결정 지점 ④ — 미결)** — 리뷰 round 1 판정: 삭제 spec render 소비 0건의 dead-restoration 동형(P1.5-c 와 논리 비대칭) + 설치 RAC 1.18.0 에 prop 부재(wiring 전제 불성립) + Skia 경로 설계 0줄                                              | reviews/915.md round 1 이슈 #2                                           |
...
| 그룹                    | 대상                             | 추가 prop                                                            | 비고                                                                                                                                                                                                                                                                               |
| ----------------------- | -------------------------------- | -------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P1.5-a contextualHelp   | 12 컴포넌트(폼/색상/컬렉션 전반) | `contextualHelp`                                                     | ⏸ **scope 재판정 대기 (2026-07-14 리뷰 round 1, 사용자 결정 지점 ④ 미결)** — 삭제 spec render 소비 0건의 dead-restoration 동형 + 설치 RAC 1.18.0 에 prop 부재("RAC wiring" 전제 불성립, 커스텀 DOM 합성 필요) + Skia 경로 설계 부재. 구 서술("전멸 복원")은 §2 이행 상태 표로 대체 |
