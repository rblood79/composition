...
| `apps/builder/src/builder/panels/properties/PropertiesPanel.tsx`                 | group/ungroup 이 `parent_id`/`order_num`을 store와 Cloud에 직접 write                                                                                                                                                                                                                                                     | `updateElement` structural-only path를 통해 canonical-primary helper 경유                                                     |
...
| `apps/builder/src/builder/stores/elementLoader.ts`                               | IndexedDB/Cloud hydrate와 page snapshot이 `order_num` 정렬을 사용                                                                                                                                                                                                                                                         | IndexedDB legacy hydrate boundary allowlist. post-hydrate page snapshot은 source order 보존                                   |
