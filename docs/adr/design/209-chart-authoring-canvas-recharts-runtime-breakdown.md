...
> 정본 결정: [ADR-209](../209-chart-authoring-canvas-recharts-runtime.md). 상태 **Accepted**, 2026-09-09. 아래 경로 중 `(신규 제안)`은 현재 존재하는 구현이 아니다. 조사 기준 HEAD `f2779b7d2`; 작업 시작 시 tracked/untracked 제품 변경 0건. 기존 readiness 작업의 goal/guard/stop은 보존한다.
