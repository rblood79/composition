...
- ruler + 수동 가이드 (감사 문서 H1 의 인접 항목 — 별도 판단)
- ~~Alt 호버 거리 측정~~ → 2026-08-13 사용자 지시로 반영 완료 (ADR 외 후속 — `interaction/measureGuides.ts`, CHANGELOG 2026-08-13. 스냅 가이드의 세그먼트·틱·배지 렌더 채널 재사용)
