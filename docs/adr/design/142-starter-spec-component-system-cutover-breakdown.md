...
| `packages/specs/src/index.ts`                                                        | `PrimitiveBinding` / `componentCatalog` / `toRacProps` export                                                                 |
...
검증: `pnpm -F @composition/specs test componentCatalog` / `pnpm -F @composition/specs build`
Gate: G3
