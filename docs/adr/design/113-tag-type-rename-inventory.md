...
| **Source refs**  | 556   | Production code (excl. **test**, .test., .spec.) |
...
| cloud.types.ts            | 2        | Cloud integration types                          |
...
element.tag = "Button";
if (el.tag === "Text") const tagValue = node.tag;
...
interface DataBinding {
  ...
  source: "cloud" | "api" | "state" | "static" | "parent";
...
apps/builder/src/types/integrations/cloud.types.ts
