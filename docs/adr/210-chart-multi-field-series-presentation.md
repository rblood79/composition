...
In Progress — 2026-09-10. P0–P3 PASS (G0–G3), P4 G4-engineering PASS. 최종 제품 revision `53c761c8b`. **열린 필수 조건 1**: G4-policy — Builder/Preview 전체 초기 번들이 기본 500,000 B 와 ADR-209 B 안 한시 상한 (1,289,801 / 626,424) 을 초과 (1,297,311 / 630,625, 순증 +7,510 / +4,201 B). ADR-210 은 예외를 자동 승계하지 않으므로 사용자의 예외 재승인 또는 축소가 있어야 G5 종결·Implemented 승격이다. 그 전까지 Implemented 로 취급하지 않는다. 원래 Proposed 2026-09-10 (코드 기준 `baf535258`, round 1·2 리뷰 승인).
