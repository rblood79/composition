...
| ID  | 위험                                                                                                                            | 심각도 | 대응                                                                                                                                         |
| --- | ------------------------------------------------------------------------------------------------------------------------------- | :----: | -------------------------------------------------------------------------------------------------------------------------------------------- |
| R1  | 기존 문서의 캔버스 배치 변화 — `height:%` 자식이 0 에서 부모 채움으로 (Preview 와 같아지지만 사용자에게는 변화)                 |  MED   | Phase 0 BC 인벤토리 (영향 = 대상 요소 N / 전체 M) · CHANGELOG Fixed 에 변화 명시 · live 1회                                                  |
...
| R5  | ④ 의 catalog Track 6 규칙이 implicitStyles 에 가려져 live 격차가 없는데 엔진 변경으로 배치가 바뀔 가능성                        |  LOW   | Phase 0 F14 live 판정 후 Phase 2 순서 결정 · `catalogComponentBox` 회귀                                                                      |
