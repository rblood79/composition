...
| 순위 | ADR                                                                                                                                                  | 착수 준비도                                                                                                                           | 차단 · 선행                                                                          |
| :--: | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
|  1   | [152](152-data-panel-collection-binding-integration.md)                                                                                              | **Accepted 2026-09-11 · 착수 중** — Phase 0 ~ 6 Implemented (G1 10/10 · G4 14/14 · G5 14/14 · P2 10/10 · G2 9/9 · P4 12/12 · P5 6/6 · G3 5/5), 다음 Phase 7 closure (`DataChange` 적용기 + History) | 승인 시 3건 동시 해소 — 013 착수 조건 G0 / 157 G1 Preview 대조 residual / 194 R7     |
