...
- **상태**: **Accepted 2026-09-11** (`/execute-adr 152` 착수) — Phase 0 Inventory freeze Implemented 2026-09-11 (G0 = 0건 → Phase 5 흡수, breakdown §1-6)
...
| 순위 | ADR                                                                                                                                                  | 착수 준비도                                                                                                 | 차단 · 선행                                                                          |
| :--: | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
|  1   | [152](152-data-panel-collection-binding-integration.md)                                                                                              | **Accepted 2026-09-11 · 착수 중** — Phase 0 Implemented (G0 = 0건), 다음 Phase 1 (계약 v2 + resolve 단일화) | 승인 시 3건 동시 해소 — 013 착수 조건 G0 / 157 G1 Preview 대조 residual / 194 R7     |
