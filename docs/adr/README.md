...
- **상태**: **Accepted 2026-09-11** (`/execute-adr 152` 착수) — Phase 0 (G0 = 0건) · Phase 1 (계약 v2 · `DataField.id` · Map id 키, G1 live 10/10) Implemented 2026-09-11 — 다음 Phase 1b
...
| 순위 | ADR                                                                                                                                                  | 착수 준비도                                                                                                        | 차단 · 선행                                                                          |
| :--: | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
|  1   | [152](152-data-panel-collection-binding-integration.md)                                                                                              | **Accepted 2026-09-11 · 착수 중** — Phase 0 · 1 Implemented (G1 live 10/10), 다음 Phase 1b (`{#id}` 템플릿 저장형) | 승인 시 3건 동시 해소 — 013 착수 조건 G0 / 157 G1 Preview 대조 residual / 194 R7     |
